...
public class MemberController {
	...
	public String saveMember(@Valid MemberDto member, BindingResult bindingResult, final RedirectAttributes redirectAttributes) {
		...
		if( member.getId() == null ) {
			...
			MemberDto updatedMember = memberService.save( member );
